...
public class WriterJobConfiguration {
	...
	@Bean
	public FilterItemProcessor itemProcessor(){
		return new FilterItemProcessor();
	}
	
	@Bean
	public Step customItemWriterFromDBStep() throws Exception{
		return stepBuilderFactory.get("customItemWriterFromDBStep")
	...
	@Bean
	public Job jobItemFilterProcessorFromDB() throws Exception{
		return jobBuilderFactory.get("jobItemFilterProcessorFromDB")
				.start(customItemWriterFromDBStep())
				.build();
	}
